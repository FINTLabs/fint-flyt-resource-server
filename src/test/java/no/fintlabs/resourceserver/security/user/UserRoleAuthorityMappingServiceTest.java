...
@DirtiesContext
public class UserRoleAuthorityMappingServiceTest {
    ...
    void createRoleAuthorities() {
        ...
        Set<GrantedAuthority> roleAuthorities = userRoleAuthorityMappingService.createRoleAuthorities(roles);
    ...
    void createRoleAuthority() {
        ...
        GrantedAuthority roleAuthority = userRoleAuthorityMappingService.createRoleAuthority(role);
